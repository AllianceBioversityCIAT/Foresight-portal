...
/**
 * This function gets the slick from the library and moves them to another location.
 *
 * @returns { stream } - returns a gulp stream.
 */
function slickTask() {
  return gulp.src( buildConfig.sources.nodeScripts.slick )
    .pipe( gulp.dest( buildConfig.destination.nodeScripts.slick ) );
}
...
function watchTask() {
  ...
  gulp.watch( buildConfig.sources.sourceFolder + '/static/js/**/*.js', jsTask, jsLibrariesTask, slickTask );
...
function loadPackage() {
  return gulp.src( buildConfig.destination.destFolder + '/**', {
...
const build  = gulp.series(
  ...
  scaffolding,
  vendorTask,
  gulp.parallel( cssTask, cssLibrariesTask, fontawesomeTask, cssRtlTask, jsTask, jsLibrariesTask, slickTask, imagesTask )
);
...
exports.package = gulp.series( updateWpVersion, build, loadPackage, prerelease );
